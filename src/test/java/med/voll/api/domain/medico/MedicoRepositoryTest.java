...
class MedicoRepositoryTest {
	...
	void escolherMedicoAleatorioLivreNaDataCenario1() {
		...
		LocalDateTime proximaSegundaAs10 = LocalDate.now()
				...
				.atTime(10, 0);
		Medico medico = cadastrarMedico("José Matedi", "medico@uol.com.br", "001122", Especialidade.CARDIOLOGIA);
		Paciente paciente = cadastrarPaciente("Mara Santos", "mara@uol.com.br", "12345678900");
	...
	void escolherMedicoAleatorioLivreNaDataCenario2() {
	 ...
	 private void cadastrarConsulta(Medico medico, Paciente paciente, LocalDateTime data) {
	    ...
	    private PacienteCadastrarDTO dadosPaciente(String nome, String email, String cpf) {
	        return new PacienteCadastrarDTO(
	                nome,
	                email,
	                "61999999999",
	                cpf,
